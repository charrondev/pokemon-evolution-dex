...
export function PokeballIcon(props: { isCaught?: boolean }) {
    const { isCaught } = props;
    const uncaught = "rgba(255, 255, 255, 0.7)";
    return (
        <svg
        ...
        >
            <g>
                <g>
                    ...
                    ></path>
                    <path
                        fill={isCaught ? "#DFDFDF" : "transparent"}
